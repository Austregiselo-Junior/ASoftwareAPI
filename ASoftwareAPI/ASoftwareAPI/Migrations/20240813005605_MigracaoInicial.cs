            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tipo = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ValorDaSessao = table.Column<int>(type: "int", nullable: true),
                    ValorTotal = table.Column<float>(type: "float", nullable: true),
                    Desconto = table.Column<float>(type: "float", nullable: true),
                    Parcelas = table.Column<float>(type: "float", nullable: true),
                    ValorDasParcelas = table.Column<float>(type: "float", nullable: true),
                    Vencimento = table.Column<int>(type: "int", nullable: true),
                    SituacaoFinanceira = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Senha = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DataDoCadastro = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UltimaAtualizacao = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
